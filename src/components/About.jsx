    ...
    <section id="about" className="py-12 md:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-10 md:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-[#5D4037] max-w-2xl mx-auto font-mono">
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            {/* Code Block */}
            <div className="bg-[#1e1e1e] rounded-lg p-3 sm:p-4 md:p-6 shadow-xl border border-gray-700 font-mono text-[10px] sm:text-xs md:text-base overflow-x-auto">
            ...
            <div className="prose prose-lg text-[#5D4037]">
              <p className="font-medium text-base sm:text-lg md:text-xl border-l-4 border-[#D4AF37] pl-3 sm:pl-4 italic">
                "Born in the heart of IITPKD, we're more than a café - we're where:
              </p>
              <ul className="list-none space-y-1.5 sm:space-y-2 mt-3 sm:mt-4 ml-1 sm:ml-2 text-sm sm:text-base">
              ...
              <p className="mt-3 sm:mt-4 font-semibold text-[#3E2723] text-sm sm:text-base">
          ...
          <div className="space-y-4 sm:space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              {statsData.map((stat, index) => {
                ...
                return (
                  <div key={index} className="bg-[#FFF8E1] p-4 sm:p-5 md:p-6 rounded-xl border-l-4 border-[#D4AF37] hover:shadow-lg transition-shadow">
                    <div className="font-mono text-[10px] sm:text-xs text-[#8D6E63] mb-2 bg-[#efebe9] p-1 rounded inline-block">
                      {stat.code}
                    </div>
                    <div className="flex items-center gap-3 sm:gap-4 mt-2">
                      <div className="bg-white p-2 sm:p-2.5 md:p-3 rounded-full shadow-sm">
                        <IconComponent className="h-5 w-5 sm:h-6 sm:w-6 text-[#D4AF37]" />
                      </div>
                      <div>
                        <div className={`font-bold text-[#3E2723] ${stat.isTextOnly ? 'text-base sm:text-lg leading-tight' : 'text-2xl sm:text-3xl'}`}>
                        ...
                        <div className="text-xs sm:text-sm font-semibold text-[#5D4037]">{stat.label}</div>
                      </div>
                    </div>
                  </div>
                );
            ...
            <div className="relative h-48 sm:h-56 md:h-64 lg:h-80 rounded-2xl overflow-hidden shadow-2xl group">
              <img
