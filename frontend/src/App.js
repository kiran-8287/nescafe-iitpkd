...
const Menu = lazyWithRetry(() => import("./components/Menu"));
...
const MiniCartBar = lazyWithRetry(() => import("./components/MiniCartBar"));
const CartDrawer = lazyWithRetry(() => import("./components/CartDrawer"));
const OrderNotificationListener = lazyWithRetry(() => import("./components/OrderNotificationListener"));
const FullMenu = lazyWithRetry(() => import("./components/FullMenu"));
const OrderConfirmPage = lazyWithRetry(() => import("./components/OrderConfirmPage"));
const FunFacts = lazyWithRetry(() => import("./components/FunFacts"));
